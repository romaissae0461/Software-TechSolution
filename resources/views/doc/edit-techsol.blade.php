...
<div class="card">
    ...
    @endif
            ...
            <div class="form-group mt-3">
            <label for="techsol_id">Technology Solution</label> 
            <select name="techsol_id" class="form-control" id="software_id">
                    @foreach($techsols as $techsol)
                        <option value="{{ $techsol->id }}" 
                            {{ $doc->techsol_id == $techsol->id ? 'selected' : '' }}>
                            {{ $techsol->name }}
                        </option>
                    @endforeach
                </select>
